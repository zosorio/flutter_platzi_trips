...
// import 'package:flutter_platzi_app/gradient_back.dart';
// import 'description_place.dart';
// import 'review_list.dart';
// import 'gradient_back.dart';
// import 'header_appbar.dart';
// import 'platzi_trips.dart';
import 'package:flutter_platzi_app/platzi_trips_cupertino.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      //App hasta el botón de favoritos.
      // home: Scaffold(
      //   body: Stack(
      //     children: [
      //       ListView(
      ...
      //     ],
      //   ),
      //   //Pone el gradiente por encima y con la lista se puede hacer scroll y que quede detrás del gradiente.
      //   // body: Stack(
      //   //   children: [
      //   //     ListView(
      //   //       children: [
